...
%%
\appendix
% \include{6A_Appendix_RsltIndiv} %参加者個人ごとの結果-anghapsad-、-calm-
% \include{6B_Appendix_DB} % 音声データベース（表）と再分類・スクリーニングの詳細結果
% \include{6C_Appendix_Morphing} % 詳細なモーフィング手順
% \include{6D_Appendix_WadaiEmoDB} % 音声収録と分析結果
% \include{6E_Appendix_CorrJND} % 相関諸々？？ JNDvs. Mean4F0,Age,SpIntel=TMTF(calはなし)、TFS（calのみ）
